...
void HariMain(void)
{
  ...
  struct SHEET *sht_back, *sht_win, *sht_mouse, *sht_win_b[3];
  unsigned char *buf_back, *buf_win, buf_mouse[256], *buf_win_b;
